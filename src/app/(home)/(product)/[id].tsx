...
import { useProductStore } from '@/components/hooks/store/useProductStore';
...
const ProductIndex = () => {
    ...
    return (
        <ScrollView className='bg-white flex flex-1 flex-col p-8 pt-16'>
            <NestedNavigationHeader navigateBack={() => router.back()} />
            <View>
                <Text className='text-xl font-bold mt-4'>{menu?.name}</Text>
